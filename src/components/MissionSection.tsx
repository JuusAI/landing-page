...
const MissionSection = () => {
  return (
    <section id="mission" className="py-32 px-4 relative overflow-hidden futuristic-bg-alt section-stack section-overlap">
      {/* Background Pattern */}
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            ...
            <div className="text-gray-600 font-light">Tasks Automated</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-light text-gradient mb-2">99.9%</div>
            <div className="text-gray-600 font-light">Uptime Guarantee</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-light text-gradient mb-2">24/7</div>
            <div className="text-gray-600 font-light">AI Support</div>
          </div>
        </div>

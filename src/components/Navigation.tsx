...
const Navigation = ({ activeSection }: NavigationProps) => {
  ...
  return (
    <>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="md:hidden">
              <button
                ...
                className={`burger-line-container p-2 ${
      ...
      {/* Mobile Menu Tray */}
      <div
        className={`fixed top-0 right-0 h-full w-80 bg-white/95 backdrop-blur-xl border-l border-gray-200 z-50 transform transition-transform duration-300 md:hidden ${
